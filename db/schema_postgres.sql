...
-- ---------------------------------------------------------------------------
-- sfsr_andringar: ändrings-SFS per grundförfattning (ett ändrings-SFS = en rad)
-- ---------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS sfsr.sfsr_andringar (
    id                      BIGSERIAL   PRIMARY KEY,
    sfs_nr                  TEXT        NOT NULL REFERENCES sfsr.sfsr_lagar (sfs_nr) ON DELETE CASCADE,
